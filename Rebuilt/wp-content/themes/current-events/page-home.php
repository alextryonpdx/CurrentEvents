...
<?php echo get_template_directory_uri(); ?>/img/banner-2880.jpg 2880w" sizes="100vw" src="<?php echo get_template_directory_uri(); ?>/img/banner-1440.jpg" alt="Current Events">
    ...
    <div id="navbar">
      <a id="nav-logo"><img src="<?php echo get_template_directory_uri(); ?>/img/logo.svg"/></a>
      <ul>
        <li><a id="nav-what" href="#what-we-do">What we do</a></li>
        <li><a id="nav-services" href="#services">Services</a></li>
        <li><a id="nav-clients" href="#clients">Clients</a></li>
        <li><a id="nav-global" href="#global">Global reach</a></li>
        <li><a id="nav-connect" href="#connect-with-us">Connect with us</a></li>
      </ul>
    ...
    <div id="mobile-navbar">
      <a id="mobile-logo"><img src="<?php echo get_template_directory_uri(); ?>/img/logo.svg"/></a>
      <a id="show-menu"><img src="<?php echo get_template_directory_uri(); ?>/img/hamburger.png"/></a>
      <a id="hide-menu"><img src="<?php echo get_template_directory_uri(); ?>/img/close.png"/></a>
      <ul>
        <li><a id="nav-what" href="#what-we-do">What we do</a></li>
        <li><a id="nav-services" href="#services">Services</a></li>
        <li><a id="nav-clients" href="#clients">Clients</a></li>
